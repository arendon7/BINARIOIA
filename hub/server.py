...
R27_HUB_CONTRACT = {
    ...
    "context_snapshot_environment": "BINARIO_CONTEXT_SNAPSHOT_ID",
    "context_hash_environment": "BINARIO_CONTEXT_HASH",
    "context_contract_environment": "BINARIO_CONTEXT_CONTRACT_VERSION",
